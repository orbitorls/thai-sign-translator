...
export const en: typeof th = {
  ...
  navTeach: "Teach",
  teachModeTab: "Teach",
  recognizeModeTab: "Recognize",
  teachIntro: "Record 3–5 clips of the same sign, then fill in the meaning",
  recordClipHint: "Press to record a clip, then press again to stop",
  clipChip: (n: number) => `Clip ${n}`,
  meaningLabel: "Meaning",
  meaningPlaceholder: "e.g. hello",
  saveSign: "Save sign",
  savingSign: "Saving...",
  signSaved: "Sign saved",
  saveSignError: "Failed to save",
  taughtSignsTitle: "Taught signs",
  noTaughtSigns: "No signs taught yet",
  recognizeHint: "Perform a sign to the camera for the system to guess",
  recognizeResult: "System guesses",
  recognizeNoSigns: "No signs taught yet. Go to the \"Teach\" tab first",
  untrainedEncoderNote: "Experimental mode: uses an untrained encoder, suitable for clearly distinct signs",
  deleteSignAria: (name: string) => `Delete sign ${name}`,
};
